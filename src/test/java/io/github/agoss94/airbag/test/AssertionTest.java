...
class AssertionTest {
    ...
    @Test
    void testInteger() {
        var actual = Tokens.from(ExpressionLexer.class, "1\n");
    ...
    @Test
    void testIdentifier() {
        var actual = Tokens.from(ExpressionLexer.class, "a\n");
        var expected = Tokens.from(ExpressionLexer.VOCABULARY, """
                [@0,0:0='a',<ID>,1:0]
                [@1,1:1='%n',<NEWLINE>,1:1]
                [@2,2:1='<EOF>',<EOF>,2:0]
    ...
    @Test
    void testAssignment() {
        var actual = Tokens.from(ExpressionLexer.class, "a = 1\n");
        var expected = Tokens.from(ExpressionLexer.VOCABULARY, """
                [@0,0:0='a',<ID>,1:0]
                [@1,2:2='=',<'='>,1:2]
                [@2,4:4='1',<INT>,1:4]
    ...
    void testComplexExpression() {
        var actual = Tokens.from(ExpressionLexer.class, "(a + b) * 2\n");
        var expected = Tokens.from(ExpressionLexer.VOCABULARY, """
                [@0,0:0='(',<'('>,1:0]
                [@1,1:1='a',<ID>,1:1]
                [@2,3:3='+',<'+'>,1:3]
    ...
    void testAnotherComplexExpression() {
        var actual = Tokens.from(ExpressionLexer.class, "(a - 5) / b\n");
        var expected = Tokens.from(ExpressionLexer.VOCABULARY, """
                [@0,0:0='(',<'('>,1:0]
                [@1,1:1='a',<ID>,1:1]
                [@2,3:3='-',<'-'>,1:3]
